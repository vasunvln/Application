...
class NotesListAdapter extends RecyclerView.Adapter<com.example.relieved.NotesListAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull com.example.relieved.NotesListAdapter.ViewHolder holder, int position) {
    ...
    @NonNull
    @Override
    public com.example.relieved.NotesListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
